...
using Kairo_Internet.BrowserTabStrip;
...
namespace Kairo_Internet {
	...
	/// <summary>
	/// The main Kairo_Internet form, supporting multiple tabs.
	...
	internal partial class MainForm : Form {
		...
		public static string Branding = "Kairo Internet";
		...
		public Stream GetResourceStream(string filename, bool withNamespace = true) {
			try {
				return assembly.GetManifestResourceStream("Kairo_Internet.Resources." + filename);
		...
		private void OnTabClosing(Kairo_Internet.BrowserTabStrip.TabStripItemClosingEventArgs e) {
